...
/**
 * Description: 用户-角色关联表实体类
 *
 * @Author: CHENZHIWEI
 * Version: 1.0
 * Create Date Time: 2024-07-02 11:12:34
 */
@ApiModel
@Data(staticConstructor = "create")
@Table(value = "oauth_user_role", onInsert = FieldInsertListener.class, onUpdate = FieldUpdateListener.class)
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
public class UserRole extends FlexModel<UserRole> implements Serializable {
	 ...
	 */
	@Column("user_id")
	@ApiModelProperty(name = "userId", value = "菜单id", dataType = "String")
