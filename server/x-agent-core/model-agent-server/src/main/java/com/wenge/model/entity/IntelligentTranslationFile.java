...
@Table(value = "intelligent_translation_file", onInsert = FieldInsertListener.class, onUpdate = FieldUpdateListener.class)
@EqualsAndHashCode(callSuper = false)
public class IntelligentTranslationFile implements Serializable {
     ...
     * 文件大小 翻译后
     */
    @Column("file_size_translate")
    @ApiModelProperty(name = "fileSizeTranslate", value = "文件大小", dataType = "Long")
    private Long fileSizeTranslate;
     ...
     * 文件路径  翻译后
     */
    @Column("file_url_translate")
    @ApiModelProperty(name = "fileUrlTranslate", value = "文件路径", dataType = "String")
    ...
    /**
     * 状态：0-上传失败-默认 1-上传成功（记录url）2-解析失败  3-解析成功 4-翻译成功 5-翻译失败  10-其他错误
     */
    @Column("status")
    @ApiModelProperty(name = "status", value = "状态：0-上传失败-默认 1-上传成功（记录url）2-解析失败  3-解析成功 4-翻译成功 5-翻译失败  10-其他错误", dataType = "Integer")
     ...
     */
    @Column("down_count")
    @ApiModelProperty(name = "downCount", value = "下载次数", dataType = "Integer")
