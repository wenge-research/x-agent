...
@ApiModel
@Data
@Table(value = "application_info_version", onInsert = FieldInsertListener.class, onUpdate = FieldUpdateListener.class)
@EqualsAndHashCode(callSuper = false)
public class ApplicationInfoVersion implements Serializable {
	 ...
	 * 应用版本号说明
	 */
	@Column("version_remark")
	@ApiModelProperty(name = "versionRemark", value = "应用版本号说明", dataType = "String")
	private String versionRemark;
	/**
	 * 应用回退说明
	 */
	@Column("back_version_remark")
	@ApiModelProperty(name = "backVersionRemark", value = "应用版本号说明", dataType = "String")
	 ...
	 * 关联知识库关联关系备份///知识库列表
	 */
	@Column("binding_knowledgeIdList_json")
	@ApiModelProperty(name = "bindingKnowledgeIdListJson", value = "关联知识库", dataType = "String")
	private String bindingKnowledgeIdListJson;//knowledgeIdList
	/**
	 * 关联知识库关联关系备份//知识库id列表
	 */
	@Column("binding_knowledgeIds_json")
	@ApiModelProperty(name = "bindingKnowledgeIdsJson", value = "关联知识库", dataType = "String")
	private String bindingKnowledgeIdsJson;//knowledgeIds
	/**
	 * 工作流关联关系备份
	 */
	@Column("binding_workflowIds_json")
	@ApiModelProperty(name = "bindingWorkflowIdsJson", value = "工作流关联关系备份", dataType = "String")
	private String bindingWorkflowIdsJson;//workflowIds
	/**
	 * 关联预设问题关联关系备份
	 */
	@Column("binding_preset_question_json")
	@ApiModelProperty(name = "bindingPresetQuestionJson", value = "关联预设问题关联关系备份", dataType = "String")
	private String bindingPresetQuestionJson;
	/**
	 * 关联敏敢词关联关系备份
	 */
	@Column("binding_intercept_wordhose_json")
	@ApiModelProperty(name = "bindingInterceptWordhoseJson", value = "关联敏敢词关联关系备份", dataType = "String")
	private String bindingInterceptWordhoseJson;
	/**
	 * 关联个性化关联关系备份
	 */
	@Column("binding_configration_json")
	@ApiModelProperty(name = "bindingConfigrationJson", value = "关联个性化关联关系备份", dataType = "String")
	private String bindingConfigrationJson;
	/**
	 * 节点信息备份
	 */
	@Column("nodes_json")
	@ApiModelProperty(name = "nodesJson", value = "关联个性化关联关系备份", dataType = "String")
	private String nodesJson;
	/**
	 * 节点关系备份
	 */
	@Column("nodeRel_json")
	@ApiModelProperty(name = "nodeRelJson", value = "节点关系备份", dataType = "String")
	private String nodeRelJson;
	/**
	 * 映射组件信息备份
	 */
	@Column("component_json")
	@ApiModelProperty(name = "componentJson", value = "映射组件信息备份", dataType = "String")
	 ...
	 */
	@Column("tts_id")
	@ApiModelProperty(name = "ttsId", value = "语音id", dataType = "String")
	 ...
	 */
	@Column("prepare_num")
	@ApiModelProperty(name = "prepareNum", value = "知识库文段预备数量(重排前的数量)", dataType = "Integer")
