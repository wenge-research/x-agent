...
import static com.wenge.model.constants.AnswerStrategyContant.LOCAL_BGE_M3_1024;

/**
 * 企商本地化部署的bge_m3,1024维，支持国际化语言
 */
@Service(LOCAL_BGE_M3_1024)
@Slf4j
public class LocalBgeM31024Strategy implements EmbeddingStrategy {
    ...
    public List<Double> embedding(String text) {
        DenseVector denseVectorCode = denseVectorService.getDenseVectorCode(LOCAL_BGE_M3_1024);
