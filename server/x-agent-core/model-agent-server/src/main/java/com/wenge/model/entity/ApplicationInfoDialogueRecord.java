...
@ApiModel
@Data
@Table(value = "application_dialogue_record", onInsert = FieldInsertListener.class, onUpdate = FieldUpdateListener.class)
@EqualsAndHashCode(callSuper = false)
public class ApplicationInfoDialogueRecord implements Serializable {
	...
	@ApiModelProperty(name = "aiQuestionId", value = "关联application_dialogue表id字段，没有业务作用", dataType = "String")
