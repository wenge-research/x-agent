...
echo 执行deepseek_r1_7b
echo 检查必要环境...


set docker_version=ccr.ccs.tencentyun.com/wenge/agent-llm:deepseek_r1_7b
set container_name=agent_x_deepseek_r1_7b
...
docker run --restart=always -d --gpus=all  -p 11435:11434 --network agent-x-network --name %container_name%  -e OLLAMA_HOST=0.0.0.0:11434   %docker_version%
