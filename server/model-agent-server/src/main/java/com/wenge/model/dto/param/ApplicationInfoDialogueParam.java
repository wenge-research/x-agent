...
@Data
public class ApplicationInfoDialogueParam extends WgPageInfo {
    /**
     * 主键，自增id，没有业务作用
     */
     ...
     */
    @Column("dialogue_id")
    @ApiModelProperty(name = "dialogueId", value = "ai对话ID", dataType = "String")
    private String dialogueId;
    /**
     * 客户端ID
     */
    @Column("client_id")
    @ApiModelProperty(name = "clientId", value = "客户端ID", dataType = "String")
