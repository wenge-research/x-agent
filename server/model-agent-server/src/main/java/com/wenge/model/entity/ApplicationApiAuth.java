...
@Table(value = "application_api_auth", onInsert = FieldInsertListener.class, onUpdate = FieldUpdateListener.class)
@EqualsAndHashCode(callSuper = false)
public class ApplicationApiAuth extends FlexModel<ApplicationApiAuth> implements Serializable {
    ...
    @Column("api_key")
    @ApiModelProperty(name = "apiKey", value = "系统生成的APIKEY", dataType = "String")
