...
@ApiModel
@Data
@Table(value = "synonym_word_key", onInsert = FieldInsertListener.class, onUpdate = FieldUpdateListener.class)
@EqualsAndHashCode(callSuper = false)
public class SynonymWordKey implements Serializable {
	...
	@Column(ignore = true)
	@ApiModelProperty(name = "type", value = "同义词列表", dataType = "String")
