<template>
	<w-layout class="layout-container flex-center">
		<!-- <w-layout-header><LayoutHeader /></w-layout-header> -->
		<w-layout class="layout-mian-height-50">
			<w-layout-sider style="width: auto;"><LayoutAside /></w-layout-sider>
