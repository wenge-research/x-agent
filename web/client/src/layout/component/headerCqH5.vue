  ...
  <w-layout-header class="top-header" style="position: absolute; top: 0">
    <!-- <div class="top-header-bg">
      <div class="flex header-left">
        <div class="homePage flex" @click="homeClick">
          <div>首页</div>
          <img class="arrow-up" src="/src/assets/chongqing/arrow-up-s-fill.svg" />
        </div>
        <div class="market">商场</div>
        <div class="market">广场</div>
      </div>
      <img class="bianzu-logo" src="/src/assets/chongqing/bianzu4.png" />
    </div> -->
