<template>
	<div class="container_chat relative" :class="wrapClass" @click="openAllDialog">
		<w-layout :class="{ MobileH: !isMobile }">
			...
			>
				<div class="chatDivFlex" :class="{ chatDivFlex2: !isMobile }" :style="particlesContainerStyle" style="width: 100vw">
			...
			<!-- xxxxxxx政务问答 -->
			<div v-if="false" class="footer-copyrightInfo" :class="{ 'footer-copyrightInfo-mobile': isMobile }">
