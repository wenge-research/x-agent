	...
	<div class="relative flex flex-col h-full w-full" :class="{ centerMobile: isMobile }">
		<div class="center-side-parent" id="bg-main" :style="`height: 100%;`">
			...
			<w-scrollbar ref="layoutScrollbarRef" class="center-side1">
				<div class="container-center-new" :class="[showSZR ? 'pt208' : '']">
...
.cq-head {
	...
	width: 100vw;
	height: 175px;
	// background-image: linear-gradient(180deg, #BBDCF4 0%, #EFF5FC 90%);
...
.center-side {
	...
	background-image: linear-gradient(180deg, #D9EDF9 0%, #F2F6FA 60%);
			// background: linear-gradient( 74deg, rgba(0, 169, 228, 0.1) 0%, rgba(84, 195, 241, 0.1) 35%, rgba(23, 40, 139, 0.1) 50%, rgba(71, 116, 185, 0.1) 56%, rgba(151, 206, 162, 0.1) 67%, rgba(177, 219, 194, 0.1) 74%, rgba(134, 202, 182, 0.11) 85%, rgba(0, 176, 151, 0.1) 100%);
