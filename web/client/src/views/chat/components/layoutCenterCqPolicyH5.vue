  ...
  <div class="relative flex flex-col h-full w-full" :class="{ centerMobile: isMobile }">
    <div class="center-side-parent" id="bg-main" :style="`height: 100%;`">
      <w-scrollbar ref="layoutScrollbarRef" class="center-side1">
        <div class="container-center-new">
          <img src="/src/assets/chongqing/digitalPeople.png" style="width: 100%; height: 617px;position: absolute;top:10px;"/>
          <div
            style=""
            ...
            <div :class="['message-list', { 'message-list-one': chatList.length }]">
              ...
              >
                <!-- <div class="fontSize16 text-black min-w-[20px] text-box-1716763096571080706 px-4 py-2 message-request text-black border-right">
									<div style="display:flex;justify-content:space-between;background: linear-gradient(0deg , rgba(2,109,187,0.2) 0%, rgba(2,109,187,0.03) 100%);border-radius: 16px;backdrop-filter: blur(1px);">
										<div style="width:90px;position:relative;">
											<img src="/src/assets/zhushou/guanxin.png" style="width:112px;max-width: 110px;position: absolute;bottom: 0;left: 0;">
											...
											<div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 6px">
												<p style="font-family: MiSans, MiSans;
													...
													font-style: normal;letter-spacing: 1px">
														<img  v-if="getAppDetail()?.identityIcon" :src="getAppDetail()?.identityIcon"> -->
                <!-- <span style="
                ...
                <div class="hotQuestions">
                  <img src="/src/assets/chongqing/title.svg" />
                  <div
                    class="ques-list"
                    v-for="(item, index) in tjQuestList"
                    @click="sendQuestion(item.question)"
              ...
              <!-- <div
                ...
                v-if="curRouteId == policyUrl && isMobile"
              >
                <div class="recommendedPolicies">
                  <div class="recommend">
                    根据您的个人信息，为您推荐一下可能适合您的政策
                  </div>
                  <div class="list">
                    <div
                      class="ques-list"
...
const heightSide = computed(() => {
  ...
  if (isMobile.value) {
    console.log(userAgent, browserList, userAgent);
    //判断是否Safari浏览器
    if (
...
.hotQuestions {
  background: linear-gradient(
      180deg,
      rgba(255, 194, 91, 0.3) 0%,
      rgba(247, 151, 78, 0) 30%
    ),
    #ffffff;
  box-shadow: 0px 4px 12px 0px rgba(27, 47, 56, 0.06);
  border-radius: 12px;
