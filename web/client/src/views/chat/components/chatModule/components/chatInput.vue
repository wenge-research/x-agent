<template>
    ...
    :max-length="isContentLengthLimit() ? 80 : null" />
		...
		<w-button type="primary" v-if="!dialogueInputLoading" :style="isMobile?'':'position:absolute;top:18px;right:20px;'"
		...
		<i v-if=" !dialogueInputLoading && isHaveTtsId()" class="vedioBtn" id="btn_control" @click="openYY('ly')" :style="isMobile?'':'top:28px;right:80px;'">
			<img src="/src/assets/chatImages/yuyin.svg"
			class="sendVoiceBtn"
