<template>
	...
	<div class="chatInput" :class="{ 'chatInput-mobiles': isMobile, 'chatInput-pc': !isMobile }">
      ...
      :class="{'active': (btnStatus === 'UNDEFINED' || btnStatus === 'CLOSED' || btnStatus === 'CLOSING') && !chatFlag}"
		...
		<!-- <div class="send-btn" @click="setInput" v-if="!dialogueInputLoading">
			<img src="" alt="">
		</div> -->
        ...
        <div v-if="text">
		    <div
		    	...
		    	><img style="width: 28px; height: 28px" src="/src/assets/chatImages/lh-send.svg" /></div
		    >
        </div>
       <div v-else>
		    <i
		    ...
		    >
		    	<img
		    		src="/src/assets/zhushou/mic1.svg"
		    		class="sendVoiceBtn"
