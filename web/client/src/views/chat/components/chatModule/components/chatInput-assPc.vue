<template>
    ...
    <div class="select-template">
      <div class="select-template-hd">
        ...
        <span class="tip">帮我写作</span>
        <w-button @click="toggleTemplateSelector" v-show="!showTemplateSelector" class="select-btn">  {{ selectedTemplateName ? selectedTemplateName : '选择模板' }}
		...
		<w-button
			...
			:style="isMobile ? '' : 'position:absolute;top:10px;right:20px;'"
