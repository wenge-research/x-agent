<template>
  ...
  <div
    class="chatInput"
    :class="{ 'chatInput-mobiles': isMobile, 'chatInput-pc': !isMobile }"
  >
		<div v-if="showToast" class="toast">无法回答该问题，我们换个话题聊聊吧</div>
    ...
    />
		...
		<span
			...
			><img style="width: 48px; height: 48px" src="/src/assets/sz-cac/send.svg"
		/></span>
		<i
		...
		>
			<img
				src="/src/assets/chatTheme/micszcac.svg"
				class="sendVoiceBtn"
...
onMounted(() => {
	...
	mittBus.on('showSensitiveWordToast', () => {
...
.chatInput-mobiles {
	...
	.w-textarea-wrapper {
		...
		box-shadow: 0px 6px 12px 0px rgba(24, 67, 104, 0.1);
		overflow-y: scroll;
		&::-webkit-scrollbar {
