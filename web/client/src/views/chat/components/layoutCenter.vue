			...
			<w-scrollbar ref="layoutScrollbarRef" class="center-side1">
				<div class="container-center">
                    ...
                    您好，我是政府在线智能问答助手，现在让我们开始交流吧！您可以在下方的输入框中输入您的问题，如果还没想好，您可以试着问我：
							...
							<div class="question-box-new" v-if="curRouteId == policyUrl && !isMobile">
								<!-- <img class="jqr-icon" style="width: 122px" :src="getAppDetail()?.facadeImageUrl || '/src/assets/zc/jqr1.png'" alt="" /> -->
								<img class="jqr-icon-new" src="/src/assets/zc/jqr1.png" alt="" /> 
								<div>
									<div style="display: flex; align-items: center; margin-bottom: 8px">
										...
										<img
											style="width: 300px"
											v-if="identityIconUrl() && identityIconUrl().includes('http')"
											:src="identityIconUrl() ? identityIconUrl() : '/src/assets/chatImages/pageTitle.svg'"
										/>
										<span v-if="identityIconUrl() && !identityIconUrl().includes('http')">{{ identityIconUrl() }}</span>
									</div>
									<div class="box">
										<div class="title">{{ getAppDetail()?.greeting }}</div>
									</div>
									<div class="quest-list" v-if="tjQuestList.length">
										<div
											class="item"
