						...
						<div class="message-list" @touchstart="handleTouchStart" @touchend="handleTouchEnd">
                            ...
                            <!-- px-4 py-2 text-black -->
								<div class="fontSize16 min-w-[20px] text-box-1716763096571080706 message-request border-right">
									<div style="display:flex;padding-top: 6px;justify-content:space-between;background: linear-gradient( 161deg, rgba(2,109,187,0.2) 0%, rgba(2,109,187,0.03) 100%), #FFFFFF;border-radius: 8px;">
											...
											<div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 4px">
												<p style="font-family: MiSans, MiSans;
													...
													font-style: normal;letter-spacing: 1px">
                                                        ...
                                                        <div
                                                          v-else
                                                          style="width: 204px; font-weight: 600; font-size: 18px; color: #313436"
                                                        >
							...
							<div :style="{ padding: isMobile ? ' 0 10px' : ' 0 30px' }" v-for="(item, index) of chatList"
								:key="index">
								<YYMessageZhengxiaodong :answer="item.answer" :dialogueId="item.dialogueId" :citations="item.citations || []" :createTime="item.createTime"
									...
									:imgUrl="item.imgUrl" :sensitive="item.sensitive" :stopChatLoading="stopChatLoading"></YYMessageZhengxiaodong>
								<YYMessageZhengxiaodong :answer="item.answer" :dialogueId="item.dialogueId" :citations="item.citations || []" :createTime="item.createTime"
									:id="item.id + ''" :dialogueFileIds="item.dialogueFileIds || []"
									:dialogueFolderIds="item.dialogueFolderIds || []" :paragraph="item.paragraph || ''"
									:skillId="item.skillId || ''" :param="item.param" :question="item.question" :loading="item.loading"
									...
									:plainText="item.plainText"></YYMessageZhengxiaodong>
							</div>
						</div>
