				...
				<div class="container-center">
					<div style="" :style="{ overflow: isMobile ? 'hidden' : 'scroll', height: heightSide }" class="center-side" v-if="!loading">
						...
						<div class="message-list">
							<div class="municipalSupervisionBureau-head" v-if="curRouteId == policyUrl && !isMobile && (getAppDetail()?.identityIcon?.includes('.png') || getAppDetail()?.identityIcon || getAppDetail()?.greeting)">
								<div v-if="getAppDetail()?.identityIcon?.includes('.png') || getAppDetail()?.identityIcon" class="title">
