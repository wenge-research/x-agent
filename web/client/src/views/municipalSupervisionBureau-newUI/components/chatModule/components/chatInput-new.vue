<template>
	...
	<div class="chatInput" :class="{ 'chatInput-mobile': isMobile, 'chatInput-pc': !isMobile }">
		...
		<w-button
			...
			:style="isMobile ? '' : 'position:absolute;top:calc(50% - 19px);right:18px;'"
		...
		<i
			...
			id="btn_control"
			@click="openYY('ly')"
			:style="isMobile ? '' : 'color: rgb(65, 134, 244);px;'"
		>
			<iconpark-icon
...
import sendIcon from '/@/assets/municipalSupervisionBureau/send.svg';
