<template>
	<div class="mobileUniversalTemplate container_chat relative" :style="{ backgroundImage: 'url(' + (backgroundImageUrl() ? backgroundImageUrl() : '/src/assets/municipalSupervisionBureau/bg-1.png') + ')' }"  :class="wrapClass" @click="openAllDialog">
