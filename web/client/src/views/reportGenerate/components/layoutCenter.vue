<template>
	<div v-if="!isAnswerShow" style="width: 100vw; display: flex; align-items: center; justify-content: center;" class="relative flex flex-col h-full w-full" :class="{ centerMobile: isMobile }">
				...
				<div class="container-center">
					<div style="" :style="{ overflow: isMobile ? 'hidden' : 'scroll', height: heightSide }"
						...
						<div class="message-list">
							<div class="appTemplate-head" style="margin-left: 160px;"
...
import { defineAsyncComponent, ref, computed, onMounted,onBeforeUnmount, watch, onUnmounted, compile, provide, } from 'vue';
...
const anserPage = defineAsyncComponent(() => import('./anserPage.vue'));
