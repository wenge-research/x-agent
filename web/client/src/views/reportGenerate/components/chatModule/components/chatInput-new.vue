		...
		<el-tooltip effect="dark" content="按需搜索网页" placement="right">
			<el-button v-if="showNetworkFlag && isShowNetWork" style="position:absolute;bottom:13px;left:16px;border:0!important;width: 106px;
				...
				<iconpark-icon name="global-line" size="17"
					:color="!chatStore.isNewWork ? '#3F4247' : 'rgb(77, 107, 254)'"
...
font-style: normal;" :style="{ color: chatStore.isNewWork ? '#4D6BFE' : '#3F4247' }">联网搜索</span>
	...
	<div class="case-box" v-show="false">
		...
		<div class="case-card">
			<div class="case-item">
				<div class="img"></div>
				<div class="name">黄金价格影响因素分析报告</div>
			</div>
			<div class="case-item">
				<div class="img"></div>
				<div class="name">黄金价格影响因素分析报告</div>
...
.case-box {
	...
	// border-image: linear-gradient(171deg, rgba(255, 255, 255, 1), rgba(255, 255, 255, 0)) 1 1;
	backdrop-filter: blur(4px);
