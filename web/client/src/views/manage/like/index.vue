	...
	<div class="like">
		...
		<div class="search_box">
			<div>
				...
				<!-- <w-select  v-model="applicationValue" placeholder="技能" @change="applicationChange" clearable>
		...
		<div>
			<w-table ref="table" :data="tableData"  :scroll="scroll" :loading="loading" :bordered="false" :pagination="pagination" @page-change="changepage" @page-size-change="changePagesize">
				...
				<w-table-column  title="分类" data-index="category"></w-table-column>
				<w-table-column  title="技能名称" data-index="app"></w-table-column>
