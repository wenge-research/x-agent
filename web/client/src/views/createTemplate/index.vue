			...
			<w-layout-sider v-if="curRouteId == policyUrl" class="flex w-layout-sider-right zcflex"
				...
				<div class="chatDivFlex" :class="{ chatDivFlex2: !isMobile, bgorImg: !backgroundImageUrl() }"
					...
					<div class="chatDivFlex-left" v-if="!implantSwitch">
						...
						<div class="footer">
							<div style="display: flex; align-items: center; margin-right: 6px; margin-top: 6px;" v-show="false">
								<div class="top">
							...
							<div class="bigImg" @mouseenter="handleMouseEnter" @mouseleave="handleMouseLeave">
								<div class="img" @click="toLogin">
									...
									<img style="width: 20px; height: 20px;" src="../../assets/login/pic_img_user.png" alt="">
								</div>
							</div>
					...
					<div class="chat-content"
						...
						<div class="chat-bottom" :class="{ 'chat-bottom-mobile': isMobile }">
							<div class="chat-bottom-content" :class="[isSZR && showSZR ? '' : '']">
								<!-- 问答 -->
								<LayoutCenter @handleFillForm="handleFillForm" @playVoiceParent="playVoiceParent" :isToken="isToken" />
							</div>
...
import { computed, defineAsyncComponent, onMounted, onUpdated, ref, defineProps, watch, nextTick, onUnmounted, provide, h, toRaw } from 'vue';
...
.bgorImg {
	...
	background-image: url(../../assets/createTemplate/create_bg.png);
