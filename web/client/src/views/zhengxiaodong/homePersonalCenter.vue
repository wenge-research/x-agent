    ...
    <div class="info-box">
      <div class="title-box">
        ...
        <div class="back-gateway" @click="backGateway">
          <img
            ...
            src="/src/assets/homePage/function-line.svg"
          />返回门户
        </div>
      </div>
      <!-- 用户信息 -->
      <div class="user-information" v-if="userInfo.username || userInfo.phone">
        <img
          ...
          src="/src/assets/chatImages/zhushoutouxiang.png"
        />
        <div>
          <div class="name">
            {{ userInfo.username }}
      ...
      <!-- <div class="basic-info flex">
        <div class="flex">
          <img
            ...
            src="/src/assets/homePage/basicInfo.png"
          />
        ...
        <div class="flex" @click="basicInfo">
          <img
            style="width: 18px; height: 18px; margin-right: 4px"
            src="/src/assets/homePage/free.png"
          />
          <div class="certified">已认证</div>
          <img
            style="width: 20px; height: 20px; margin-left: 16px"
            src="/src/assets/homePage/arrow-right-s-line.png"
          />
        </div>
      </div> -->
      <!-- 历史对话 -->
...
const chatClick = (item: any) => {
  router.push(`/assistantMobile/${getAppDetail()?.applicationCode}`);
  setTimeout(() => {
...
.information-view {
  ...
  .info-box {
    width: 100%;
    height: 150px;
    background: url("/@/assets/chatImages/bg-2.png") no-repeat;
  ...
  .person-bottom {
    ...
    .basic-info {
      ...
      background: linear-gradient(
        270deg,
        rgba(191, 255, 253, 0.19) 0%,
        rgba(23, 166, 164, 0.19) 100%
      );
      border-radius: 8px;
      padding: 16px 15px;
      justify-content: space-between;
