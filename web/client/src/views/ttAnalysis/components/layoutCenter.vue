<template>
	<div class="ttAnalysis relative flex flex-col h-full w-full" :class="{ centerMobile: isMobile }">
			...
			<w-scrollbar ref="layoutScrollbarRef" class="center-side1">
				<div class="container-center">
					<div
						...
						class="center-side center-side-ttAnalysis"
						v-if="!loading"
					>
						...
						<div class="message-list">
							...
							>
								<div
									...
									"
								>
									<img :src="virtualHumanLogo" alt="" class="ttAnalysis-head-facadeImageUrl" />
								</div>

								<div
									v-if="getAppDetail()?.identityIcon || getAppDetail()?.greeting"
						...
						<!-- <div v-if="!isMobile" :style="{ 'padding-bottom': '16px' }"></div> -->
					</div>
