  ...
  <div class="chat-container">
    <div class="chat-container-cont">
        ...
        <div class="input-wrapper">
          ...
          <div class="input-area">
            <div class="options-row">
              <w-select v-model="model"  placeholder="请选择模型" style="width: auto;min-width: 246px;color: #828894">
      ...
      <div class="bottom-list">
        <a target="_blank" href="http://10.158.248.228/wg-agent-client/#/knowledgeDetails/45d39bf71a444b58a32921a7c596ca02"><img  :src="link5" alt="" ></img></a>
