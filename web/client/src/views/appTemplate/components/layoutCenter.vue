				...
				<div class="container-center">
					<div style="" :style="{ overflow: isMobile ? 'hidden' : 'scroll', height: heightSide }" class="center-side" v-if="!loading">
						...
						<div class="message-list">
							<div class="appTemplate-head" v-if="curRouteId == policyUrl && !isMobile && (virtualHumanLogo || getAppDetail()?.identityIcon || getAppDetail()?.greeting)">
								...
								<div v-if="getAppDetail()?.identityIcon || getAppDetail()?.greeting" style="flex: 1;overflow: hidden;padding: 22px 0">
									<div class="title">
							...
							<div v-if="tjQuestList?.length" class="quest-list">
								...
								<div v-for="(item, index) in tjQuestList" :key="index" class="quest-list-box">
									<div class="item" :title="item.question" @click="sendQuestion(item.question)" :class="{ active: curQuestion == item.question }">
...
font-style: normal;">{{ item.question }}</span>
							...
							<div style="display: flex;margin-top: 32px;" :style="{ padding: isMobile ? ' 0 10px' : '0 0 0 0' }" v-if="curRouteId == policyUrl && getAppDetail()?.prologue">
