<template>
  ...
  <div class="tj" v-if="!isMobile" :style="{ 'justify-content': 'flex-end' }">
    <div @click="gotoTop" class="right-back">
      <div class="back">
        <img src="/src/assets/longhuaNewUI/totop.png" alt="" />
      </div>
    </div>
  </div>
  <div
  ...
  >
    ...
    <!-- <Vue3Lottie
      ...
      :width="55"
    /> -->
    <div v-if="dialogueInputLoading && !uploadImgStatusLoading" class="loading-btn"></div>
  </div>
</template>
...
.chatInput {
  ...
  .loading-btn {
    ...
    right: 20px;
    bottom: 24px;
    background: url("/src/assets/longhuaNewUI/loading.png") center no-repeat;
    border-radius: 50%;
  }
  @keyframes rotate2 {
    0% {
