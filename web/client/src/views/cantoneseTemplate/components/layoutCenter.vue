				...
				<div class="container-center">
					<div style="" :style="{ overflow: isMobile ? 'hidden' : 'scroll', height: heightSide }" class="center-side" v-if="!loading">
						...
						<div class="message-list">
							<div class="appTemplate-head" v-if="curRouteId == policyUrl && !isMobile && (!isDefaultImg(facadeImageUrl) || getAppDetail()?.identityIcon || getAppDetail()?.greeting)">
								<div v-if="facadeImageUrl && !isDefaultImg(facadeImageUrl)" style="height: 88px;align-self: flex-start;">
									<img :src="facadeImageUrl" alt="" class="appTemplate-head-facadeImageUrl" />
								</div>
								
								<div v-if="getAppDetail()?.identityIcon || getAppDetail()?.greeting" style="flex: 1;overflow: hidden;margin-left: 24px">
									<div class="title">
							...
							<div style="display: flex;margin-top: 32px;" :style="{ padding: isMobile ? ' 0 10px' : '0 36px 0 0' }" v-if="curRouteId == policyUrl && getAppDetail()?.prologue">
