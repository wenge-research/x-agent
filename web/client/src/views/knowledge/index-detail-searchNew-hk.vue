<template>
  <div class="ai-mian">
    ...
    <div class="mian-box" v-if="isSearch">
      <img class="logo-img" src="/src/assets/images/zhuShouLog.png" alt="" />
      <!-- 切换模型功能 -->
      <!-- <div class="tab-box">
        <div
          class="tab"
      ...
      <div class="input-box mt30 ">
        ...
        <el-autocomplete
          ...
          v-model="searchText"
          :fetch-suggestions="querySearch"
          placeholder="Enter the question you want to search for"
          ...
          <w-list-item>
            <w-list>
              <w-list-item class="zidingyi-w-list-item-content" v-for="(item, index) in questionChartsTop50List" :key="index" @click="sendClickSearch(item.question)">
                <div class="flex justify-between items-center activehove">
      ...
      <!-- 新版问题top10 -->
      <searchNewTop type="hk" :topList="questionChartsTop50List"  @emitQuestion="sendClickSearch" v-if="questionChartsTop50List&&questionChartsTop50List.length"></searchNewTop>
    ...
    <div v-if="!isSearch" class="result-box">
      <div class="result-header" >
            ...
            <div class="inputRe-box" >
              <div class="inputRe-content">
                ...
                <w-select
                  ...
                  :style="{ width: '120px' }"
                  style="margin-left: 0;padding:0 0 0 10px;"
                  placeholder="请选择"
                  :bordered="false"
                />
                <div class="line"></div>
        ...
        <div class="new-user-box flex items-center">
      ...
      <div class="result-tab-box" >
          ...
          <div>
            ...
            <div class="result-tabs">
              <div
                ...
                :key="index"
                class="tab-item"
                :class="{ active: resultActiveTab === item }"
                @click="resultActiveTabFun(item)"
              >
        ...
        <div class="result-border" v-show="resultActiveTab!=='ai-answers'"></div>
      </div>
      <div class="result-content-box" >
        <div v-show="resultActiveTab === 'ai-answers'" >
          <searchResultAI
            v-if="isShowResult"
            :loading="isSearch"
        ...
        <div v-show="resultActiveTab === 'document'" >
          <indexDetailResultFile type="hk" :fileName="searchText" ref="childComponent"></indexDetailResultFile>
        </div>
        <div v-show="resultActiveTab === 'picture'" >
          <indexDetailResultImg type="hk" :fileName="searchText" ref="childComponent1"></indexDetailResultImg>
        </div>
    ...
    <div v-if="false" class="previewPdf" >
        ...
        <div>
          <layoutCenterPdfPdf v-if="previewClicklist.transPdfUrl" :url="previewClicklist.transPdfUrl"></layoutCenterPdfPdf>
        </div>
      </div>
  </div>
</template>
...
import { getPresetQuestionList, questionChartsTop50, questionRealtimeRecommendTopN,getFileSizeList } from "/@/api/knowledge";
...
let resultActiveTab = ref('ai-answers')
let resultTabList = ref(['ai-answers','document','picture'])
