	...
	<div class="ai-mian">
		...
		<div class="mian-box" v-if="isSearch">
				...
				<div class="btn-box audio">
					<div class="left-btn">
						<w-space style="background: #f4f6f9; border-radius: 8px">
							...
							<span>类型：</span>
							<w-select :style="{ width: '100px' }" placeholder="全部" :bordered="false">
								<w-option style="color: #828894">全部</w-option>
			...
			<div class="question-tab" v-if="tjQuestList.length > 0">
				<w-space>
					<w-button type="secondary" shape="round" v-for="(item, index) in tjQuestList" :key="index" @click="sendQuestion(item.question)">
					...
					<w-button type="secondary" shape="round">
						...
						<span @click="getPresetQuestionListFun">换一批</span>
					</w-button>
				</w-space>
			</div>
			<div class="topic-box">
				...
				<w-list :gridProps="{ gutter: 0, span: 12 }" :bordered="false" style="border: none">
					<w-list-item>
						<w-list>
							<w-list-item>
								<span class="sort">01</span>
								<span class="text">在项目伊始时做一个用户研究的作用好过于…</span>
							</w-list-item>
							<w-list-item><span class="sort">03</span> <span class="text">不理解人，就无法理解什么是设计</span></w-list-item>
							<w-list-item><span class="sort">05</span> <span class="text">在项目伊始时做一个用户研究的作用好过于…</span></w-list-item>
							<w-list-item><span class="sort">07</span> <span class="text">不理解人，就无法理解什么是设计</span></w-list-item>
							<w-list-item><span class="sort">09</span> <span class="text">好设计关心环境因素</span></w-list-item>
						</w-list>
					</w-list-item>
					<w-list-item>
						<w-list>
							<w-list-item>
								...
								<span class="text">好设计是美的</span>
							</w-list-item>
							<w-list-item><span class="sort">04</span> <span class="text">产品创造于工厂，而品牌创造于心灵</span></w-list-item>
							<w-list-item><span class="sort">06</span> <span class="text">在项目伊始时做一个用户研究的作用好过于…</span></w-list-item>
							<w-list-item><span class="sort">08</span> <span class="text">使用设计工具的好处在于，当这些项目材料...</span></w-list-item>
							<w-list-item><span class="sort">10</span> <span class="text">少，却更好</span></w-list-item>
						</w-list>
					</w-list-item>
				</w-list>
			</div>
		...
		<div class="mian-box" v-if="!isSearch">
			...
			<searchResultAI :loading="isSearch" :searchText="searchSureText" :searchWay="isSearch ? activeName : valueName"></searchResultAI>
		</div>
	</div>
</template>
...
// 结果页
const searchResultAI = defineAsyncComponent(() => import('./components/searchResult.vue'));
...
// 推荐问题
const tjQuestList = ref([{ question: '设计有哪些要素？' }, { question: '有哪些设计构图方法？' }, { question: '什么是好的设计？' }]);
