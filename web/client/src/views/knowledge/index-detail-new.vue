<template>
  <div class="container_chat relative" :class="wrapClass" @click="openAllDialog">
    <w-layout :class="{ MobileH: !isMobile }">
          ...
          <div class="chat-content">
            <div class="top-logo" v-if="!isMobile">
              <div>
                ...
                <img v-else class="lh-logo" src="/src/assets/chatImages/pageTitle.svg" />
                <!-- <img class="lh-logo" src='/src/assets/zc/logo-new.png' /> -->
              </div>
              <div class=" right">
      ...
      <w-layout-sider v-if="curRouteId == judicialUrl" class="w-layout-sider-right flex" :style="particlesContainerStyle"
        :resize-directions="previewData.active && route.params.appId != 0 ? ['left'] : []">
    ...
    <el-dialog :show-close="false" v-model="formVisible"
      width="760px" :close-on-press-escape="false" :close-on-click-modal="false">
...
const LayoutCenter = defineAsyncComponent(() => import('/@/views/chat/components/layoutCenter-new.vue'));
...
.container_chat :deep(.w-layout-sider-right) {
  ...
  .chatDivFlex2 {
    ...
    position: relative;
    background: url(../../assets/zc/bg11-new.png) no-repeat;
    background-size: 100% 100%;
