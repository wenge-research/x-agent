<template>
	<div ref="messageRef" class="yy-message-mobileUniversalTemplate w-full items-start"
		...
		<div :class="['flex-shrink-0', inversion ? 'ml8' : 'mr8']">
			<AvatarComponent :isLoading="loading" :image="inversion" />
		</div>
		<div class="fontSize16 max-w-full items-start" style="max-width: calc(100vw - 64px);">
			...
			<div class="relative" :class="[inversion ? 'flex-row-reverse' : 'flex-row']" ref="textRef">
				...
				<div v-if="!inversion && finishReason === 'ANSWER_COMPLETE'" class="btns adaption">
					<!-- 播放 -->
