          ...
          <template #footer>
            ...
            <div v-if="!inversion && !loading" style="background: #fff;padding-top: 0;">
              ...
              <!-- <div>
			    ...
			    <div class="buttons">
					<!-- <div class="left" @click="handleBofang">
                      <CoolVolumeUpLineWe size="16" color="#0182E5"/>
					  <span class="yy-bofang">
						语音播报
					  </span>
					</div> -->
                    ...
                    <w-button type="text" shape="circle" v-if="!inversion" @click="handleBofang">
					  ...
					  <!-- <span style="color:#A6A5B8;font-size:14px;">语音播报</span> -->
					</w-button>
                  </w-tooltip>
					<div class="right">
						<w-button
...
import TextComponent from './TextPolicy.vue';
...
const sourceAnswerList = async () => {
	...
	if (res?.code == '000000') {
		syList.value = res?.data?.sourceAnswerResultList || [];
	} else {
		syList.value = [];
	}
};
