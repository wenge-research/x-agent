...
const wrapClass = computed(() => {
  return [
    ...
    props.inversion ? 'text-message-requests' : 'text-message-reply',
...
<template>
	<div class="text-black" style="border: 1px solid #fff; position: relative" :class="wrapClass">
		<div ref="textRef" class="leading-relaxed break-words" :class="maxHight">
			<!-- 知识库 -->
			<div v-if="!inversion">
				<div v-if="!asRawText && text" class="markdown-body"
        ...
        <div class="markdown-body" v-html="geTailTalk()" v-if="finishReason === 'ANSWER_COMPLETE'" />
