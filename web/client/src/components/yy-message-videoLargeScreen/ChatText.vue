...
const wrapClass = computed(() => {
	return [
		...
		props.inversion ? 'text-message-request-a' : 'text-message-reply-b',
...
<template>
	<div class="text-black" style="position: relative" :class="wrapClass">
		<img v-if="!inversion" src="/src/assets/videoLargeScreen/line.png" alt="" style="position: absolute;top: 0;right: 0;">
		<div ref="textRef" class="leading-relaxed-new break-words" :class="maxHight">
			<!-- 知识库 -->
			<div v-if="!inversion">
				<slot name="header" v-if="!asRawText && text"></slot>
				<div
					v-if="!asRawText && text"
					class="markdown-body stopTxt"
				...
				<div v-if="!asRawText && !text" class="markdown-body icon-box">
					...
					<!-- <img style="width: 18px; height: 18px; margin-right: 10px" src="/src/assets/mobileUniversalTemplate/think.svg" />
					<span>飞速思考中</span> -->
				...
				<div v-if="finishReason === 'ANSWER_COMPLETE' && geTailTalk()" class="markdown-body" v-html="geTailTalk()" />
