<template>
  <div ref="messageRef" class="flex w-full items-start"
    :class="[{ 'mb-3 mt-3 flex-row-reverse': inversion, 'mb-3 ml-3 mr-6': !inversion }, className]">
    <div :class="['flex-shrink-0', inversion ? 'ml-3 mr-3' : 'mr-3']">
      <AvatarComponent v-if="!isMobile" :isLoading="loading" :image="inversion" />
    </div>
    <div class="fontSize16 items-start" style="max-width: 84%;">
                      ...
                      <w-button type="text" class="cxsc" @click="handleSelect('toggleRender')">
                        ...
                        <span style="color:#383D47;">重新回答</span>
								...
								<w-popover placement="top" width="460" trigger="hover" content-class="disclaimer-popover">
									<div v-if="getmzsm()" class="rebuildBtn mzsm">
                    <w-button type="text" class="cxsc">
                ...
                <div v-if="appId != '20'" style="position:relative;">
                  ...
                  <w-tooltip :content="isPlayer ? '停止' : '播放'" placement="top" mini> 
                    <w-button type="text" shape="circle" v-if="!inversion">
											...
											<div v-if="isPlayer && clientId == clientIdNew" style="width: 14px;height: 100%" @click="szrStopBofang">
												<div id="preloader"> 
													<div id="loader">
