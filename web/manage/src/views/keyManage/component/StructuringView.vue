<template>
  <div class="structuring-view document-view">
    <LeftTree @change="handleNodeClick" :type="5" :knowledgeId="knowledgeId"></LeftTree>
    <div class="view-right-wrapper">
      <div class="right-header">
        ...
        <div class="btns-box">
          <el-button v-if="!isAll" type="primary" icon="el-icon-plus" @click="createTask">{{$t('newStructuringTask')}}</el-button>
        </div>
      </div>
      <div class="table-btns">
        ...
        <el-button type="text" :disabled="multipleSelection.length === 0" icon="el-icon-delete"
          ...
          <el-table-column fixed="right" :label="$t('action')" width="160">
            <template slot-scope="scope">
              <div class="btns">
                ...
                <el-button type="text" @click="remTask(scope.row)">{{$t('delete')}}</el-button>
              </div>
            </template>
          </el-table-column>
        </el-table>
        ...
        <div class="sql-con" v-if="[2].includes(taskActive)">
          <el-form :model="sqlForm" ref="sqlForm" :rules="rules">
            ...
            <el-form-item :label="$t('password')" prop="jdbcPassword">
              <el-input v-model="sqlForm.jdbcPassword" :placeholder="$t('pleaseEnterPassword')"></el-input>
            </el-form-item>
          </el-form>
        </div>
