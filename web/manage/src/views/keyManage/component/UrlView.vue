...
<template>
  <div class="url-view document-view">
    <LeftTree @change="handleNodeClick" :type="3" :knowledgeId="knowledgeId" @cancel="handleTreeCancel"></LeftTree>
    <div class="view-right-wrapper">
      <div class="right-header">
        ...
        <div class="btns-box">
          <el-button type="primary" icon="el-icon-plus" @click="addUrlDialog">{{$t('addUrl')}}</el-button>
          ...
          <el-table-column fixed="right" :label="$t('action')" width="120">
            <template slot-scope="scope">
              <div class="btns">
                ...
                <el-button type="text" @click="remUrlData(scope.row.urlId)">{{$t('delete')}}</el-button>
              </div>
            </template>
          </el-table-column>
        </el-table>
