  ...
  <div class="kbm-view">
    <div v-if="!showStatistical">
      <transition name="el-fade-in-linear">
        <KbmList ref="KbmList" v-show="showView === 'kbmList'" @change-view="changeKbmView" @showStatisticalPage="showStatisticalPage"/>
      </transition>
      <transition name="el-fade-in-linear">
    ...
    <transition name="el-fade-in-linear">
      <StatisticalPage ref="StatisticalPage" v-if="showStatistical" @close="showStatisticalPage"></StatisticalPage>
    </transition>
  </div>
</template>

<script>
import KbmList from '@/views/Kbm/component/KbmList.vue'
import KbmCreate from '@/views/Kbm/component/KbmCreate.vue'
import StatisticalPage from '@/views/Kbm/component/StatisticalPage.vue'
export default {
  components: {
    KbmList,
    KbmCreate,
