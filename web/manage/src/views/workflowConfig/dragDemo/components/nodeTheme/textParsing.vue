            ...
            <div v-show="showSub">
                ...
                <div class="model flex items-center justify-between">
                    ...
                    <div class="w-full h-full flex items-center flex-1">
                        <div
                            class="result-cont"
                            v-if="node.data && node.data.type && node.data.type ===  'variable'"
                        >
                        <ul
                        v-if="appForm.inputs && appForm.inputs.length"
                    >
                        ...
                        <div
                            class="result-cont"
                            v-else-if="configItems && configItems.length"
                        >
                            {{ configItems[0].name
                            }}<span>{{  configItems[0].type }}</span>
                        </div>
                        <div
                            class="result-cont"
                            v-else-if="appForm.inputs && appForm.cusType"
                        >
                            {{ appForm.inputs[0].label
                            }}<span>{{ appForm.cusType }}</span>
                        </div>
                        <div class="result-cont" v-else>
