                    ...
                    <el-collapse-item name="0">
                        <template slot="title">
                            <div class="title-flex">
                                <span>{{ $t('input') }}</span>
                                <div class="icon-ctn">
                                <el-tooltip popper-class="workflow-tooltip" effect="dark" :content="'输入需要从知识中匹配的关键信息'" placement="top" :effect="'light'">
                    ...
                    <el-collapse-item name="2">
                        <template #title>
                            <div class="title-flex">
                                <span>知识库</span>
                                <div class="icon-ctn">
                                <el-tooltip popper-class="workflow-tooltip" effect="dark" :content="'选择需要匹配的知识范围，仅从选定的知识中召回信息，可添加多个知识库'" placement="top" :effect="'light'">
                                    <iconpark-icon name="question-line" size="16" color="#C9CDD4" style="margin-left: 5px;"></iconpark-icon>
                                </el-tooltip>
                                </div>
                            </div>
