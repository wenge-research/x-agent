<template>
  <div class="matter-type">
    <div class="matter-type-search">
      ...
      <el-button type="primary" style="margin-left: auto" @click="addMatter">
        ...
        <div style="margin-top: 16px">
          ...
          >
            ...
            <el-table-column
              ...
              width="180"
            ></el-table-column>
            <el-table-column prop="showFlag" :label="$t('enable')" width="90">
            ...
            <el-table-column :label="$t('action')" width="140">
              <template slot-scope="scoped">
                ...
                <el-button type="text" @click="deleteHandler(scoped.row)">{{
                  $t("delete")
                }}</el-button>
              </template>
            </el-table-column>
